...
public class HomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTransportIdEditText.setText(mDriverO.getUserName());
    ...
    private void checkInputFields() {
        if (mTransportIdEditText.length() == 0 || mEmailEditText.length() == 0 ||
            ...
            Toast.makeText(HomeActivity.this, R.string.missing_inputs, Toast.LENGTH_SHORT).show();
        } else {
            // Store values.
    ...
    private void startLocationService() {
        ...
        Intent intent1 = new Intent(this, TrackerService.class);
        Gson gson = new Gson();
        intent1.putExtra("driverO",gson.toJson(mDriverO));
